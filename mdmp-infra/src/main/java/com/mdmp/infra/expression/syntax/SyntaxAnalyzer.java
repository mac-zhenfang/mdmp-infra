...
import com.mdmp.infra.expression.tokens.ExecutionToken;
import com.mdmp.infra.expression.tokens.FunctionToken;
import com.mdmp.infra.expression.tokens.NonterminalToken;
...
public class SyntaxAnalyzer {
	List<Executable> johnnyList = new ArrayList<Executable>();
	/**
	 * 文法
	 */
	...
	public Valuable analysis(List<TerminalToken> tokens, Map<String, Valuable> variableInitialValues)
		...
		for(Executable executable : johnnyList){
			System.out.println(executable.toString());
			System.out.println(executable.getArgumentNum());
			//execute(executable);
		}
		return finalResult;
	}
