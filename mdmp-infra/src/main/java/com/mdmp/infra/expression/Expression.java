...
public class Expression {
	...
	public Set<String> getVariableNames() throws LexicalException {
		...
		for(TerminalToken terminalToken : _tokens)
	...
	public List<TerminalToken> lexicalAnalysis() throws LexicalException {
		_tokens = lexicalAnalyzer.analysis(expression, functionDefinitions);
		return _tokens;
	}
	...
	public Valuable evaluate() throws SyntaxException {
		...
		//语法分析，返回最终结果
		finalResult = syntaxAnalyzer.analysis(_tokens, variableInitialValues);
		//设置执行之后变量值
